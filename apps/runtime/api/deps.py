...
from apps.runtime.core.async_db import get_async_session, get_explicit_transaction_session
from apps.runtime.core.imaging.object_store import (
    OSSObjectStore,
    ObjectStorageGateway,
)
from apps.runtime.core.contexts import CallerContext, ControlPlaneContext

if TYPE_CHECKING:
    from apps.runtime.service.image_service import ImageService
...
async def get_session_service(db=Depends(get_async_session)):
    from apps.runtime.service.session_service import SessionService

    return SessionService(db)


async def get_study_service(db=Depends(get_async_session)):
    from apps.runtime.service.study_service import StudyService
