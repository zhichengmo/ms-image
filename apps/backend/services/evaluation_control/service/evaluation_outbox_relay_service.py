"""Evaluation outbox persistence boundary for the shared relay workflow."""
...
class EvaluationOutboxRelayService:
    """Expose Evaluation outbox relay operations without leaking its DAL to Workers."""

    DESTINATION_KEY = EvaluationOutboxDal.DESTINATION_KEY
...
__all__ = ["EvaluationOutboxRelayService"]
